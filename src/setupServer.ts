...
export class ChattyServer {
    ...
    private globalErrorHandler(app: Application): void {
        app.all("*", (req: Request, res: Response) => {     // I express for urls which are not yet defined and for all url we'll use app.all("*")
    ...
    private async startServer(app: Application): Promise<void> {        //create server
        try {
    ...
    private async createSocketIO(httpServer: http.Server): Promise<Server> {    // so.. instead of returning vois we'll return Server
